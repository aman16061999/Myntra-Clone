    ...
    <Box width={'100%'} >
        ...
        <Image src={HomePageHeader}
          ...
          />
           ...
           <Box>
          <Image src='https://www.gyftr.com/blog/wp-content/uploads/2019/12/Bannernew_myntra-3-1.jpg' alt='omgDeals' />
          ...
          <Image src='https://www.gyftr.com/blog/wp-content/uploads/2019/04/banners21554285340.jpg' alt='grandBrands' />
          <Grid gridTemplateColumns={["repeat(3,1fr)","repeat(6,1fr)","repeat(6,1fr)","repeat(9,1fr)"]} gap={[0,0,0,0]} >
